package com.monkeyframework.qos.collector.core.utils;
...
public class DateFormatUtils {
	...
	protected final static Logger logger = Logger.getLogger(DateFormatUtils.class);

	public static String pattern19  = "yyyy-MM-dd HH:mm:ss";
	public static String pattern14  = "yyyyMMddHHmmss";
	public static String pattern12  = "yyyyMMddHHmm";

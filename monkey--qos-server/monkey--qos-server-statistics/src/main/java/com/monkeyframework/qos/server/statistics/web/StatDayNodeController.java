...
@Controller
@RequestMapping("/day_stat_node")
public class StatDayNodeController extends BaseController {
	
	@Resource
	private DayStatNodeService dayStatNodeService;
	
	private String viewModel = "day_stat_node/";
	...
	public String test01(Model model, Pagination page, HttpServletRequest request) {
		...
		List<DayStatNode> list 
			= dayStatNodeService.findPageByAppAndDay(page, startDay, endDay, consumerAppName, providerAppName);
